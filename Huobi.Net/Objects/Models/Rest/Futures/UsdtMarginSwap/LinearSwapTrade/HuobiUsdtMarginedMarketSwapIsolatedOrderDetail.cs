...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapTrade
{
    ...
    /// 【逐仓】获取用户的合约订单明细信息
    /// </summary>
    public class HuobiUsdtMarginedMarketSwapIsolatedOrderDetail
    {
        /// <summary>
        /// 品种代码
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedTrade> HuobiUsdtMarginedIsolatedTrades { get; set; } = Array.Empty<HuobiUsdtMarginedTrade>();
    }    
}
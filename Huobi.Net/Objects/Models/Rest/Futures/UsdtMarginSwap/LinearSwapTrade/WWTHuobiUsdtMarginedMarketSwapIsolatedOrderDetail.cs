...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapTrade
{
    ...
    /// 【逐仓】获取用户的合约订单明细信息
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapIsolatedOrderDetail
    {
        /// <summary>
        /// 品种代码
        /// </summary>
        ...
        public IEnumerable<WWTHuobiUsdtMarginedTrade> HuobiUsdtMarginedIsolatedTrades { get; set; } = Array.Empty<WWTHuobiUsdtMarginedTrade>();
    }    
}
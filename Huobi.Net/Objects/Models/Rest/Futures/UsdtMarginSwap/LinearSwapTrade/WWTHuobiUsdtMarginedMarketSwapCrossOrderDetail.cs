...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapTrade
{
    ...
    /// 【全仓】获取用户的合约订单明细信息
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapCrossOrderDetail
    {
        /// <summary>
        ...
        public IEnumerable<WWTHuobiUsdtMarginedTrade> HuobiUsdtMarginedCrossTrades { get; set; } = Array.Empty<WWTHuobiUsdtMarginedTrade>();
    }
}
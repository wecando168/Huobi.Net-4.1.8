...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapAccount
{
    ...
    /// 【逐仓】批量获取子账户资产信息
    /// </summary>
    public class WWTHuobiUsdtMarginedIsolatedSubAccountInfoList
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<WWTHuobiSubAccountIsolatedInfoList> SubAccountIsolatedInfoLists { get; set; } = Array.Empty<WWTHuobiSubAccountIsolatedInfoList>();
    }
}
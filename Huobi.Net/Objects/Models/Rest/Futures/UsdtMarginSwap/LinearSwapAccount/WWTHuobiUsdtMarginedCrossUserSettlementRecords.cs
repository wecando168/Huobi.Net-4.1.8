...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapAccount
{
    ...
    /// </summary>
    public class WWTHuobiUsdtMarginedCrossUserSettlementRecords
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<CrossSettlementRecord> SettlementRecords { get; set; } = Array.Empty<CrossSettlementRecord>();
    }

    /// <summary>
    /// 结算记录
    /// </summary>
    public class CrossSettlementRecord
    {
        /// <summary>
        /// 保证金模式	cross：全仓模式
        /// </summary>
        ...
        public IEnumerable<ContractDetail> ContractDetails { get; set; } = Array.Empty<ContractDetail>();
    }
    ...
    public class ContractDetail
    {
        ...
        public IEnumerable<CrossSettlementRecordPosition> Positions { get; set; } = Array.Empty<CrossSettlementRecordPosition>();
    }

    /// <summary>
    /// 结算记录持仓
    /// </summary>
    public class CrossSettlementRecordPosition
    {
        /// <summary>
        /// 品种代码	"BTC","ETH"...
        /// </summary>

namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【全仓】获取计划委托当前委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapCrossTriggerOpenOrders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedCrossTriggerOpenOrder> HuobiUsdtMarginedCrossTriggerOpenOrders { get; set; } = Array.Empty<HuobiUsdtMarginedCrossTriggerOpenOrder>();
    }

    /// <summary>
    /// 【全仓】计划委托当前委托信息
    /// </summary>
    public class HuobiUsdtMarginedCrossTriggerOpenOrder
    {
        /// <summary>

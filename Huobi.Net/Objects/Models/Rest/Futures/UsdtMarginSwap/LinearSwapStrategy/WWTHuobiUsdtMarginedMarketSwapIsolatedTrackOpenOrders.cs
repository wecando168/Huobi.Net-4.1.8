namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【逐仓】跟踪委托订单当前委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapIsolatedTrackOpenOrders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedIsolatedTrackOpenOrder> HuobiUsdtMarginedIsolatedTrackOpenOrders { get; set; } = Array.Empty<HuobiUsdtMarginedIsolatedTrackOpenOrder>();
    }

    /// <summary>
    /// 【逐仓】跟踪委托订单信息
    /// </summary>
    public class HuobiUsdtMarginedIsolatedTrackOpenOrder
    {
        /// <summary>
        /// 品种代码
        /// </summary>

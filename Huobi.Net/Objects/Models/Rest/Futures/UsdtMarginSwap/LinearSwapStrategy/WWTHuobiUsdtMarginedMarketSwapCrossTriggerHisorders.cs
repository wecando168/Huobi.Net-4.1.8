namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【全仓】获取计划委托历史委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapCrossTriggerHisorders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedCrossTriggerHisorders> HuobiUsdtMarginedCrossOpenOrders { get; set; } = Array.Empty<HuobiUsdtMarginedCrossTriggerHisorders>();
    }

    /// <summary>
    /// 【全仓】计划委托历史委托信息
    /// </summary>
    public class HuobiUsdtMarginedCrossTriggerHisorders
    {
        /// <summary>

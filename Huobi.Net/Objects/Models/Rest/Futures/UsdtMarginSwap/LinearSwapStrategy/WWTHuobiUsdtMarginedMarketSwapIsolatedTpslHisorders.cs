namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【逐仓】查询止盈止损订单历史委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapIsolatedTpslHisorders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedIsolatedTpslHisOrder> HuobiUsdtMarginedIsolatedTpslHisOrders { get; set; } = Array.Empty<HuobiUsdtMarginedIsolatedTpslHisOrder>();
    }

    /// <summary>
    /// 【逐仓】止盈止损订单历史信息
    /// </summary>
    public class HuobiUsdtMarginedIsolatedTpslHisOrder
    {
        /// <summary>
        /// 品种代码
        /// </summary>

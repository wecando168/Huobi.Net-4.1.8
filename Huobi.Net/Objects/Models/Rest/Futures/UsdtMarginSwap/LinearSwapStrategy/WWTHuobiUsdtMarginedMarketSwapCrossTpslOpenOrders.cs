namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【全仓】查询止盈止损订单当前委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapCrossTpslOpenOrders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedCrossTpslOpenOrder> HuobiUsdtMarginedCrossTpslOpenOrders { get; set; } = Array.Empty<HuobiUsdtMarginedCrossTpslOpenOrder>();
    }

    /// <summary>
    /// 【全仓】止盈止损订单信息
    /// </summary>
    public class HuobiUsdtMarginedCrossTpslOpenOrder
    {
        /// <summary>

namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMarginSwap.LinearSwapStrategy
{
    ...
    /// 【逐仓】获取计划委托当前委托
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSwapIsolatedTriggerOpenOrders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedIsolatedTriggerOpenOrder> HuobiUsdtMarginedIsolatedTriggerOpenOrders { get; set; } = Array.Empty<HuobiUsdtMarginedIsolatedTriggerOpenOrder>();
    }

    /// <summary>
    /// 【逐仓】计划委托当前委托信息
    /// </summary>
    public class HuobiUsdtMarginedIsolatedTriggerOpenOrder
    {
        /// <summary>
        /// 品种代码
        /// </summary>

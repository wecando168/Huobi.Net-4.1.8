...
namespace Huobi.Net.Objects.Models.Rest.Futures.UsdtMargined.LinearSwapStrategy
{
    ...
    /// 【全仓】跟踪委托订单历史委托
    /// </summary>
    public class HuobiUsdtMarginedMarketSwapCrossTrackHisorders
    {
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public IEnumerable<HuobiUsdtMarginedCrossTrackHisorder> HuobiUsdtMarginedCrossTrackHisorders { get; set; } = Array.Empty<HuobiUsdtMarginedCrossTrackHisorder>();
    }

    /// <summary>
    /// 【全仓】跟踪委托订单历史委托
    /// </summary>
    public class HuobiUsdtMarginedCrossTrackHisorder
    {
        /// <summary>

...
namespace Huobi.Net.Objects.Models.Socket.Futures.UsdtMargined.WebSocketOrderAndAccounts
{
    ...
    /// 【逐仓】订阅合约订单撮合数据
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSubscriboMatchOrder
    {
        /// <summary>
        ...
        /// <summary>
        /// 【逐仓】Websocket推送成交记录信息
        /// </summary>
        [JsonProperty("trade", NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<WSIsolatedTradeInfo> WSIsolatedTradeInfos { get; set; } = Array.Empty<WSIsolatedTradeInfo>();
    }

    /// <summary>
    /// 【逐仓】Websocket推送成交记录信息
    /// </summary>
    public class WSIsolatedTradeInfo
    {
        /// <summary>

...
namespace Huobi.Net.Objects.Models.Socket.Futures.UsdtMargined.WebSocketOrderAndAccounts
{
    ...
    /// 【全仓】获取用户的合约订单明细信息
    /// </summary>
    public class WWTHuobiUsdtMarginedMarketSubscribeCrossOrderData
    {
        /// <summary>
    ...
    /// <summary>
    /// 【全仓】U本位合约WebSocket推送成交明细
    /// </summary>
    public class HuobiUsdtMarginedWSCrossTrade : WWTHuobiUsdtMarginedTrade
    {
        /// <summary>
        /// 手续费币种	“USDT”
        /// </summary>

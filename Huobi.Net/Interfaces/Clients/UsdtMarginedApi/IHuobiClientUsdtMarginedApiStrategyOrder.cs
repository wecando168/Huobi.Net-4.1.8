...
namespace Huobi.Net.Interfaces.Clients.UsdtMargined
{
    ...
    public interface IHuobiClientUsdtMarginedApiStrategyOrder
    {
        ...
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerOrder>> LinearSwapTriggerOrderAsync(
            string contractCode,
            string triggerType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerCancel>> LinearSwapTriggerCancelAsync(
            string contractCode,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerCancel>> LinearSwapTriggerCancelAllAsync(
            string contractCode, 
            string? direction,
            string? offset,
            CancellationToken ct = default
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerOpenOrders>> GetLinearSwapTriggerOpenordersAsync(
            string contractCode,
            int? pageIndex = null,
            int? pageSize = null,
            int? tradeType = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerHisorders>> GetLinearSwapTriggerHisordersAsync(
            string contractCode,
            int tradeType,
            string status,
            int createDate,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTpslOrder>> LinearSwapTpslOrderAsync(
            string contractCode,
            string direction,
            decimal volume,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerCancel>> LinearSwapTpslCancelAsync(
            string contractCode,
            IEnumerable<long>? orderIdList,             
            CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapCrossTriggerCancel>> LinearSwapCrossTpslCancelAsync(
            IEnumerable<long>? orderIdList,
            string? contractCode,
            string? pair,
            string? contractType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTriggerCancel>> LinearSwapTpslCancelAllAsync(
            string contractCode,
            string? direction,
            CancellationToken ct = default
            );
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapCrossTriggerCancel>> LinearSwapCrossTpslCancelAllAsync(            
            string? contractCode,
            string? pair,
            string? contractType,
            string? direction,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTpslOpenOrders>> GetLinearSwapTpslOpenordersAsync(
            string contractCode,
            int? pageIndex = null,
            int? pageSize = null,
            int? tradeType = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTpslHisorders>> GetLinearSwapTpslHisordersAsync(
            string contractCode,
            string status,
            long createDate,
            int? pageIndex = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapRelationTpslOrder>> GetLinearSwapRelationTpslOrderAsync(
             string contractCode,
             long orderId, 
             CancellationToken ct = default
            );
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTrackOrder>> LinearSwapTrackOrderAsync(
            string contractCode,
            string direction,
            int volume,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTrackCancel>> LinearSwapTrackCancelAllAsync(
             string contractCode,
             string? direction,
             string? offset,
             CancellationToken ct = default
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTrackOpenOrders>> GetLinearSwapTrackOpenOrdersAsync(
            string contractCode,
            int? tradeType,
            int? pageIndex = null,
            int? pageSize = null, 
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<HuobiUsdtMarginedMarketSwapTrackHisorders>> GetLinearSwapTrackHisordersAsync(
            string contractCode,
            string status,
            int tradeType,
            long createDate,

...
namespace Huobi.Net.Interfaces.Clients.UsdtMargined
{
    ...
    public interface IHuobiClientUsdtMarginedApiStrategyOrder
    {
        ...
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTriggerOrderAsync(
            string contractCode,
            string triggerType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTriggerOrderAsync(
            string triggerType,
            decimal triggerPrice,
            long volume,
            string direction,
        ...
        /// </summary>
        /// <param name="contractCode">合约代码	永续：“BTC-USDT”... , 交割：“BTC-USDT-210625”...</param>
        /// <param name="orderId">用户订单ID（多个订单ID中间以","分隔,一次最多允许撤消20个订单 ）</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTriggerCancelAsync(
            string contractCode,
            string orderId,
            CancellationToken ct = default
            );
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTriggerCancelAsync(
            string orderId,
            string? contractCode,
            string? pair,
            string? contractType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTriggerCancelAllAsync(
            string contractCode, 
            string? direction,
            string? offset,
            CancellationToken ct = default
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTriggerCancelAllAsync(
            string? contractCode,
            string? pair,
            string? contractType,
            string? direction,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapTriggerOpenordersAsync(
            string contractCode,
            int? pageIndex = null,
            int? pageSize = null,
            int? tradeType = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapCrossTriggerOpenordersAsync(
            string? contractCode,
            string? pair,
            int? pageIndex = null,
            int? pageSize = null,
        ...
        /// <param name="create_date">日期		可随意输入正整数，如果参数超过90则默认查询90天的数据</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapTriggerHisordersAsync(
            string contractCode,
            int tradeType,
            string status,
            int create_date,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTpslOrderAsync(
            string contractCode,
            string direction,
            decimal volume,
        ...
        /// <param name="slOrderPriceType">止损委托类型  不填默认为limit; 限价：limit ，最优5档：optimal_5，最优10档：optimal_10，最优20档：optimal_20</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTpslOrderAsync(
            string direction,
            decimal volume,
            string? contractCode,
            string? pair,
        ...
        /// </summary>
        /// <param name="contractCode">合约代码	"BTC-USDT" ...</param>
        /// <param name="orderId">止盈止损订单ID（多个订单ID中间以","分隔,一次最多允许撤消10个订单 ）	</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTpslCancelAsync(
            string contractCode,
            string orderId,             
            CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTpslCancelAsync(
            string orderId,
            string? contractCode,
            string? pair,
            string? contractType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapCrossTpslOpenordersAsync(
            string? contractCode,
            string? pair,
            int? pageIndex = null,
            int? pageSize = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapRelationTpslOrderAsync(
             string contractCode,
             long orderId, 
             CancellationToken ct = default
            );
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTrackOrderAsync(
            string contractCode,
            string direction,
            decimal volume,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTrackOrderAsync(
            string direction,
            decimal volume,
            decimal callbackRate,
            decimal activePrice,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTrackCancelAsync(
            string contractCode, 
            string orderId,
            CancellationToken ct = default
            );
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTrackCancelAsync(
            string orderId,
            string? contractCode,
            string? pair,
            string? contractType,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapTrackCancelAllAsync(
             string contractCode,
             string? direction,
             string? offset,
             CancellationToken ct = default
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> LinearSwapCrossTrackCancelAllAsync(
            string? contractCode,
            string? pair,
            string? contractType,
            string? direction,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapTrackOpenOrdersAsync(
            string contractCode,
            int? tradeType,
            int? pageIndex = null,
            int? pageSize = null, 
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapCrossTrackOpenordersAsync(
            string? contractCode,
            string? pair,
            int? tradeType,
            int? pageIndex = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapTrackHisordersAsync(
            string contractCode,
            string status,
            int tradeType,
            long createDate,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<Object>>> GetLinearSwapCrossTrackHisordersAsync(
            string status,
            int tradeType,
            long createDate,
            string? contractCode,

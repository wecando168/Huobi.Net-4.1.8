...
namespace Huobi.Net.Interfaces.Clients.UsdtMargined
{
    ...
    public interface IHuobiSocketClientUsdtMarginedStreams
    {
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeOrderContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> UnsubscribeOrderContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeOrderCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeAccountsContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeAccountsCrossContractCodeAsync(string marginAccount, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<Object>> onData, CancellationToken ct = default);

...
namespace Huobi.Net.Interfaces.Clients.SpotApi
{
    ...
    /// 现货数据流
    /// </summary>
    public interface IHuobiSocketClientSpotApi : IDisposable
    {
        /// <summary>
        ...
        /// <returns></returns>
        Task<CallResult<IEnumerable<WWTHuobiSpecifiedTimeKLine>>> GetSpecifiedTimeKLinesAsync(string symbol, KlineInterval period, long startTimeStamp, long endTimeStamp);

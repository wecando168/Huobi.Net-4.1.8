...
namespace Huobi.Net.Interfaces.Clients.UsdtMarginSwapApi
{
    ...
    public interface IHuobiSocketClientUsdtMarginSwapStreams
    {
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeOrderContractCodeAsync(string contractCode, string clientId, Action<DataEvent<HuobiUsdtMarginedMarketSubscribeOrderData>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeOrderCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<HuobiUsdtMarginedMarketSubscribeCrossOrderData>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeAccountsContractCodeAsync(string contractCode, string clientId, Action<DataEvent<IEnumerable<HuobiUsdtMarginedAccountSebscribePositionInfo>>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeAccountsCrossContractCodeAsync(string marginAccount, string clientId, Action<DataEvent<IEnumerable<HuobiUsdtMarginedAccountSebscribeCrossPositionInfo>>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersContractCodeAsync(string contractCode, string clientId, Action<DataEvent<HuobiUsdtMarginedMarketSubscriboMatchOrder>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">用于关闭此订阅的取消令牌 Cancellation token for closing this subscription</param>
        /// <returns></returns>
        Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<HuobiUsdtMarginedMarketSubscriboCrossMatchOrder>> onData, CancellationToken ct = default);

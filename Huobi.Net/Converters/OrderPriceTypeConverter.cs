...
{
    internal class OrderPriceTypeConverter : BaseConverter<OrderPriceType>
    {
        public OrderPriceTypeConverter() : this(true) { }
        public OrderPriceTypeConverter(bool quotes) : base(quotes) { }

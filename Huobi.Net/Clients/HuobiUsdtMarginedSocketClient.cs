...
{
    /// <inheritdoc cref="IHuobiUsdtMarginedSocketClient" />
    public class HuobiUsdtMarginedSocketClient : BaseSocketClient, IHuobiUsdtMarginedSocketClient
    {
        #region fields
        /// <inheritdoc />
        ...
        #region ctor
        /// <summary>
        /// Create a new instance of HuobiUsdtMarginedSocketClient with default options
        /// </summary>
        public HuobiUsdtMarginedSocketClient() : this(HuobiUsdtMarginedSocketClientOptions.Default)
        {
        }
        ...
        public HuobiUsdtMarginedSocketClient(HuobiUsdtMarginedSocketClientOptions options) : base("Huobi", options)
        {
            HuobiSocketClientUsdtMarginedStreams? item = AddApiClient(new HuobiSocketClientUsdtMarginedStreams(log, this, options));
            UsdtMarginedStreams = AddApiClient(new HuobiSocketClientUsdtMarginedStreams(log, this, options));
        ...
        public static void SetDefaultOptions(HuobiUsdtMarginedSocketClientOptions options)
        {
            HuobiUsdtMarginedSocketClientOptions.Default = options;
        }
        #region private
        ...
        protected override bool HandleQueryResponse<T>(SocketConnection s, object request, JToken data, out CallResult<T> callResult)
        {
            ...
            if (isV1QueryResponse)
            {
                ...
                if (!desResult)
                {
                    log.Write(LogLevel.Warning, $"Socket {s.SocketId} Failed to deserialize data: {desResult.Error}. Data: {data}");
        ...
        protected override bool HandleSubscriptionResponse(SocketConnection s, SocketSubscription subscription, object request, JToken message, out CallResult<object>? callResult)
        {
            ...
            if (isError)
            {
                ...
                if (request is HuobiAuthenticatedSubscribeRequest haRequest)
                {
                    ...
                    log.Write(LogLevel.Warning, $"Socket {s.SocketId} Subscription failed: " + subResponse.Data.Code);
            ...
            if (v2Sub)
            {
                ...
                if (!subResponse.Data.IsSuccessful)
                {
                    log.Write(LogLevel.Warning, $"Socket {s.SocketId} Subscription failed: " + subResponse.Data.Message);

...
namespace Huobi.Net.Clients
{
    ...
    public class HuobiSpotClient : BaseRestClient, IHuobiSpotClient
    {
        #region Api clients
        ...
        /// </summary>
        public HuobiSpotClient() : this(HuobiSpotClientOptions.Default)
        {
        }
        ...
        /// </summary>
        public HuobiSpotClient(HuobiSpotClientOptions options) : base("Huobi", options)
        {
        ...
        public static void SetDefaultOptions(HuobiSpotClientOptions options)
        {
            HuobiSpotClientOptions.Default = options;
        }

...
{
    /// <inheritdoc />
    public class HuobiClientUsdtMarginedApiMarketData : IHuobiClientUsdtMarginedApiMarketData
    {
        // 市场行情接口
        ...
        internal HuobiClientUsdtMarginedApiMarketData(HuobiClientUsdtMarginedApi baseClient)
        {

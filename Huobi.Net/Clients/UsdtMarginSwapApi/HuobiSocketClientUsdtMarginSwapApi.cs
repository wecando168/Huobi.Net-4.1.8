...
namespace Huobi.Net.Clients.UsdtMarginSwapApi
{
    ...
    public class HuobiSocketClientUsdtMarginSwapApi : SocketApiClient, IHuobiSocketClientUsdtMarginSwapApi
    {
        ...
        #region ctor
        internal HuobiSocketClientUsdtMarginSwapApi(Log log, HuobiSocketClientOptions options)
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeOrderContractCodeAsync(string contractCode, string clientId, Action<DataEvent <WWTHuobiUsdtMarginedMarketSubscribeOrderData>> onData, CancellationToken ct = default)
        {
            contractCode = contractCode.ValidateHuobiContractCode();
            ...
            Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscribeOrderData>>? internalHandler = new Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscribeOrderData>>
                (
                data =>
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeOrderCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscribeCrossOrderData>> onData, CancellationToken ct = default)
        {
            contractCode = contractCode.ValidateHuobiContractCode();
            var request = new HuobiSocketRequest2
                (
            ...
            Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscribeCrossOrderData>>? internalHandler = new Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscribeCrossOrderData>>
                (
                data =>
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeAccountsContractCodeAsync(string contractCode, string clientId, Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribePositionInfo>>> onData, CancellationToken ct = default)
        {
            contractCode = contractCode.ValidateHuobiContractCode();
            var request = new HuobiSocketRequest2
                (
            ...
            Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribePositionInfo>>>? internalHandler = new Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribePositionInfo>>>
                (
                data =>
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeAccountsCrossContractCodeAsync(string marginAccount, string clientId, Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribeCrossPositionInfo>>> onData, CancellationToken ct = default)
        {
            ...
            //});
            Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribeCrossPositionInfo>>>? internalHandler = new Action<DataEvent<IEnumerable<WWTHuobiUsdtMarginedAccountSebscribeCrossPositionInfo>>>
                (
                data =>
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersContractCodeAsync(string contractCode, string clientId, Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboMatchOrder>> onData, CancellationToken ct = default)
        {
            contractCode = contractCode.ValidateHuobiContractCode();
            HuobiSubscribeRequest? request = new HuobiSubscribeRequest
                (
            ...
            Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboMatchOrder>>? internalHandler = new Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboMatchOrder>>
                (
                data =>
        ...
        /// <inheritdoc />
        public async Task<CallResult<UpdateSubscription>> SubscribeMatchOrdersCrossContractCodeAsync(string contractCode, string clientId, Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboCrossMatchOrder>> onData, CancellationToken ct = default)
        {
            contractCode = contractCode.ValidateHuobiContractCode();
            HuobiSubscribeRequest? request = new HuobiSubscribeRequest
                (
            ...
            Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboCrossMatchOrder>>? internalHandler = new Action<DataEvent<WWTHuobiUsdtMarginedMarketSubscriboCrossMatchOrder>>
                (
                data =>

...
{
    /// <inheritdoc />
    public class HuobiClientUsdtMarginSwapApiTransferring : IWWTHuobiClientUsdtMarginSwapTransferring
    {
        // U本位合约划转接口
        ...
        internal HuobiClientUsdtMarginSwapApiTransferring(HuobiClientUsdtMarginSwapApi baseClient)
        {

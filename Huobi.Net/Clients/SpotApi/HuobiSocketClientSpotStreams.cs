...
namespace Huobi.Net.Clients.SpotApi
{
    ...
    public class HuobiSocketClientSpotStreams : SocketApiClient, IHuobiSocketClientSpotStreams
    {
        ...
        #region ctor
        internal HuobiSocketClientSpotStreams(Log log, HuobiSocketClientOptions options)
        ...
        public async Task<CallResult<IEnumerable<HuobiSpecifiedTimeKLine>>> GetSpecifiedTimeKLinesAsync(string symbol, KlineInterval period, long startTimeStamp, long endTimeStamp)
        {
            ...
            CallResult<HuobiSocketResponse<IEnumerable<HuobiSpecifiedTimeKLine>>>? result = await QueryAsync<HuobiSocketResponse<IEnumerable<HuobiSpecifiedTimeKLine>>>(request, false).ConfigureAwait(false);

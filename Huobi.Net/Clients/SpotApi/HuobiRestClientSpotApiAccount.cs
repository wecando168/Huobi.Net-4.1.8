...
namespace Huobi.Net.Clients.SpotApi
{
    ...
    public class HuobiRestClientSpotApiAccount : IHuobiClientSpotApiAccount
    {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<WWTHuobiSubUserCreation>>> SubUserCreationAsync(WWTHuobiCreateSubUserAccountRequest huobiCreateSubUserAccountRequest, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            ...
            return await _baseClient.SendHuobiRequest<IEnumerable<WWTHuobiSubUserCreation>>(_baseClient.GetUrl($"sub-user/creation", "2"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<WebCallResult<WWTHuobiLockOrUnlockSubUser>> LockOrUnlockSubUserAsync(long subUid, WWTSubAccountManageAction action, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("subUid", subUid);
            parameters.AddOptionalParameter("action", JsonConvert.SerializeObject(action, new WWTSubAccountManageActionConverter(false)));
            return await _baseClient.SendHuobiRequest<WWTHuobiLockOrUnlockSubUser>(_baseClient.GetUrl($"sub-user/management", "2"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<WebCallResult<WWTHuobiSubUserAPIKeyCreation>> SubUserAPIKeyCreationAsync(string otpToken, long? subUid = null, string? note = null, string permission = "readOnly", string? ipAddresses = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            ...
            return await _baseClient.SendHuobiRequest<WWTHuobiSubUserAPIKeyCreation>(_baseClient.GetUrl($"sub-user/api-key-generation", "2"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<WebCallResult<WWTHuobiSubUserAPIKeyModification>> SubUserAPIKeyModificationAsync(long? subUid, string accessKey, string? note = null, string? permission = null, string? ipAddresses = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("subUid", subUid);
            ...
            parameters.AddOptionalParameter("ipAddresses", string.IsNullOrWhiteSpace(ipAddresses) ? null : ipAddresses);
            return await _baseClient.SendHuobiRequest<WWTHuobiSubUserAPIKeyModification>(_baseClient.GetUrl($"sub-user/api-key-modification", "2"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }

        /// <inheritdoc />
        public async Task<WebCallResult<WWTHuobiSubUserAPIKeyDeletion>> SubUserAPIKeyDeletionAsync(long? subUid = null, string? accessKey = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("subUid", subUid);
            parameters.AddOptionalParameter("accessKey", accessKey);
            WebCallResult<WWTHuobiSubUserAPIKeyDeletion>? result = await _baseClient.SendHuobiRequest<WWTHuobiSubUserAPIKeyDeletion>(_baseClient.GetUrl($"sub-user/api-key-deletion", "2"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
            return result;
            //return result.As(result.Success);
        }

        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<WWTHuobiAPIKeyQuery>>> APIKeyQueryAsync(long? uid = null, string? accessKey = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("uid", uid);
            parameters.AddOptionalParameter("accessKey", accessKey);
            return await _baseClient.SendHuobiRequest<IEnumerable<WWTHuobiAPIKeyQuery>>(_baseClient.GetUrl($"user/api-key", "2"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
    }
}

...
namespace Huobi.Net.Clients.SpotApi
{
    ...
    public class HuobiRestClientSpotApiExchangeData : IHuobiClientSpotApiExchangeData
    {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<WWTHuobiMarketStatus>> GetMarketStatusAsync(CancellationToken ct = default)
        {
            return await _baseClient.SendHuobiV2Request<WWTHuobiMarketStatus>(_baseClient.GetUrl(MarketStatusEndpoint, "2"), HttpMethod.Get, ct).ConfigureAwait(false);
        }

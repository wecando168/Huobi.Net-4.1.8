...
namespace Huobi.Net.Clients.SpotApi
{
    ...
    public class HuobiRestClientSpotApi : RestApiClient, IHuobiClientSpotApi, ISpotClient
    {
        ...
        internal HuobiRestClientSpotApi(Log log, HuobiClientOptions options)
        ...
        public override TimeSyncInfo GetTimeSyncInfo()
            => new TimeSyncInfo(_log, _options.SpotApiOptions.AutoTimestamp, _options.SpotApiOptions.TimestampRecalculationInterval, _timeSyncState);
